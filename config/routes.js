...
router.patch('/users/me', authMiddleware.isAuthenticated, tasksController.checkCurrentDate, usersController.checkLastAccess, usersController.update)
router.delete('/users/me', authMiddleware.isAuthenticated, usersController.delete)

//tasks
router.post('/tasks/new', authMiddleware.isAuthenticated, tasksController.checkCurrentDate, usersController.checkLastAccess, tasksController.create)
...
router.patch('/tasks/:id', authMiddleware.isAuthenticated, tasksController.checkCurrentDate, usersController.checkLastAccess, tasksController.update)
router.delete('/tasks/:id', authMiddleware.isAuthenticated, tasksController.delete)

//sessions
router.post('/login', authMiddleware.isNotAuthenticated, tasksController.checkCurrentDate, usersController.checkLastAccess, usersController.login)
